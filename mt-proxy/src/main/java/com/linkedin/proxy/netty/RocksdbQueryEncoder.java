...
public class RocksdbQueryEncoder extends MessageToMessageEncoder<Query>
{
  private static final byte[] CONTENT = {'D', 'O', 'N', 'E'};
  private static final Logger _LOG = Logger.getLogger(MysqlQueryEncoder.class);

  @Override
  protected void encode(ChannelHandlerContext ctx, Query msg, List<Object> out) throws Exception
  {
